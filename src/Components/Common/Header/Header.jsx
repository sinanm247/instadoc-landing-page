        ...
        <nav className='navbar-container'>
            <div className={`navbar ${isSticky ? "sticky" : ""} ${location.pathname === "/thank-you" ? "thank-you-header" : ""}`}>
                ...
                <div className="call-div-right">
                    <a href="tel:+971503509100" className="service-button-link" target="_blank" rel="noopener noreferrer"> 
                        <div className="service-button">
                            <img src={service247Icon} alt="24/7 Services" className="service-icon" />
                        </div>
                    </a>
                    <a href="https://wa.me/971503509100" target="_blank" rel="noopener noreferrer"> 
                        <div className="whatsapp-button">
                            <FaWhatsapp className="whatsapp-icon-btn" />
                            <span className="whatsapp-number">050 350 9100</span>
                        </div>
                    </a>
                </div>
